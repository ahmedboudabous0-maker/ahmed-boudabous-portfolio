          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 space-y-6">
              ...
              <div className="flex items-start gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <div className="text-gray-900 font-medium">ahmedboudabous0@gmail.com</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <div className="text-gray-900 font-medium">+216 23242929</div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-8 shadow-xl text-white">
              ...
              <div className="flex gap-3">
                <a 
                  href="https://www.linkedin.com/in/ahmed-boudabous-3200a4361/" 
                  target="_blank" 
                ...
                <a 
                  href="https://www.github.com/ahmedboudabous0-maker" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-white/20 hover:bg-white/30 rounded-xl flex items-center justify-center transition-all backdrop-blur cursor-pointer"
                  title="GitHub"
                ...
                <a 
                  href="ahmedbooudabous0@gmail.com" 
                  className="w-12 h-12 bg-white/20 hover:bg-white/30 rounded-xl flex items-center justify-center transition-all backdrop-blur cursor-pointer"
                  title="Email"
                >
